...
export default function EventCanceled({
  username,
  title,
  reason,
}: EventCanceledProps) {
      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-gray-100 font-sans">
          <Container className="mx-auto my-[3rem] w-[30rem] rounded-xl border border-solid border-[#eaeaea] bg-white p-[2rem]">
            ...
            <Text className="text-[14px] leading-[24px] text-black">
              The event you were invited to, <strong>{title}</strong>, has been
              canceled by the host. They provided the following message:
            </Text>
